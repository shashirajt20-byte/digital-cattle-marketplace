    ...
    <main className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-50 p-4 rounded-lg border">
                <p className="text-xs text-gray-500 mb-1">Seller Status</p>
                <p className="font-semibold text-green-600">Active Seller</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg border border-emerald-200 text-emerald-700 hover:bg-emerald-50 transition text-sm font-medium"
              >
                View Orders
              </button>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Seller dashboard • Manage cattle & orders efficiently
        </p>
